...
func removeCmd() *cli.Command {
	return &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.BoolFlag{
				Name:  "delete-folder",
				Usage: "Delete the extension directory from the .verso-extensions folder",
			},
		},
...
func runExtenstionRemove(cmd *cli.Command) error {
	...
	if isDeleteFolder {
		// Remove the extension directory from ".verso-extensions"
		extensionDir := filepath.Join(".verso-extensions", extensionName)
