...
Add the plugin configuration to your `.semver.yaml`:
...
5. **CI validation**: Add a CI check that runs `semver show` to catch inconsistencies

## Troubleshooting

### Plugin Not Running

Check that the plugin is enabled in `.semver.yaml`:
